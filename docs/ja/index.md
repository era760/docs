...
features:
    - icon: ⚡️
      title: 軽快！
      details: 'bridge. なら、拡張性の高いコンパイラ設計、充実した自動補完、作業内容のリアルタイムプレビューによって、より速く開発できます。'
      link: /guide/features/
      linkText: 詳細はこちら
    - icon: 🛠️
      title: 拡張機能！
      details: 'カスタムコンポーネント、カスタムコマンド、ファイルプリセット、テーマ... bridge.の拡張機能を使えば、ほぼ何でも実現できます。すでに充実した拡張機能のエコシステムから、お好みのものを選ぶこともできます。'
      link: /extensions/
      linkText: 詳細はこちら
    - icon: 🚀
      title: シームレス！
